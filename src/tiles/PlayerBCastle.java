...
public class PlayerBCastle extends BoardTiles {

    public PlayerBCastle(int row, int col) {
        super(row, col);
    }

    /**
     * Метод за визуализиране на полетата, от които се състои територията на PlayerB.
